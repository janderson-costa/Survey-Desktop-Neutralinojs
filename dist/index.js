(() => {
  ...
  function NeutralinoService() {
    ...
    async function openFile2(options = { filePath: "" }) {
      const result = createResult();
  ...
  function SrvService() {
    ...
    async function newFile2(options = { minimizeWindow: null }) {
  ...
  var renderIcons = () => lucide.createIcons();
  ...
  function createUI() {
    ...
    const _toolbarActionsLeft = [
      ...
      { title: "Informa\xE7\xF5es do arquivo", icon: Icon("info"), onClick: () => showFileInfo() },
  ...
  function createDataTable(srvTable) {
    return DataTable({
      id: srvTable.id,
      data: [],
      place: null,
